...
> **novella-droid — [celia-sh/Novella](https://github.com/celia-sh/Novella) 的修改版：Android 移植。**
>
> 上游是仅支持 iOS 的客户端；本仓库在其基础上增加了 Android 支持，自 2026-09 起修改。
> 依照 AGPL-3.0 第 5 条，此声明表明本仓库为修改版本（modified version）并给出修改日期。
